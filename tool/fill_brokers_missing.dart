...
Future<void> main() async {
  ...
  if (url.isEmpty || key.isEmpty) {
    stderr.writeln(
      'ERROR: Set SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY env vars before running.',
    );
    exit(1);
  }
  ...
  print(
    'Done. Only empty fields were filled; nothing existing was overwritten.',
  );
}
